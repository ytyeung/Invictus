...
SERVER_ID=subprocess.Popen('julius -input adinnet -quiet -C /home/pi/julius4/Invictus_HK.jconf',shell=True,stdout=subprocess.PIPE)
    ...
    def run(self):	
        ...
        # peek at the abort variable
            ...
            if self._want_abort == 0:
                ...
                global RECOG_ID
                #RECOG_ID=subprocess.Popen('julius -input rawfile -filelist /home/pi/julius4/recfile -quiet -C /home/pi/julius4/Invictus_HK.jconf -outfile',shell=True)
                #RECOG_ID.wait()
            ...
            if self._want_abort == 0:
                ...
                #wx.PostEvent(self._notify_window,ResultEvent(found))
                wx.PostEvent(self._notify_window,ResultEvent(found.decode('utf-8')))
                self._notify_window.ResetButton()
